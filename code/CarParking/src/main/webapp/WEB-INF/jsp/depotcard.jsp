...
function alertCard(status) {
	...
	$.ajax({
		type:'get',
		url:'./card/findDepotCardByCardnum',
		datatype:'json',
...
function rechargeDepotCardSubmit()
{
	...
	$.ajax({
		type:'post',
		url:'./card/rechargeDepotCardSubmit',
		datatype:'json',
		data:$("#checkForm").serializeArray(),
		success:function(data){
			if(data.code==100)
