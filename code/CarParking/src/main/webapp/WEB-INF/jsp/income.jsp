    ...
    <table class="table">
        <caption>
            ...
            <div class="dropdown" style="float: right; margin-right: 10%">
                ...
                <%--						<a href="${APP_PATH }/index/incomeCharts" target="main"--%>
                <%--						   onclick="$('div#main').load(this.href);return false;"><input type="button" value="收入分析"  class="btn btn-default"><a/>--%>
